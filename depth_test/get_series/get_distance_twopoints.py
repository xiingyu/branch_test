...
try:
    while True:
        ...
        #640 by 360
        color_img = cv2.circle(color_img,(640,360),5,(0,0,255), -1, cv2.LINE_AA)
        ...
        center_distance = depth_image[360][640] * depth_scale
        ...
        if circles :
            if len(circles) == 2 :
                ...
                cv2.putText(color_img, f'{second_distance:.4f} m {circles[1][0]} by {circles[1][1]}', (30,90), cv2.FONT_HERSHEY_DUPLEX, 1, (0,0,255),2)
