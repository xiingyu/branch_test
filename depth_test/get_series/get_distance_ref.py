...
try:
    while True:
        ...
        result = model.predict(color_image, classes=[0., 67.], conf= 0.25, max_det = 2)
        ...
        # annotated_img = cv2.circle(annotated_img,((object_xy[1]),(object_xy[0])),10,(255,0,0), -1, cv2.LINE_AA)
        # annotated_img = cv2.circle(annotated_img,((400),(600)),10,(255,0,0), -1, cv2.LINE_AA)
